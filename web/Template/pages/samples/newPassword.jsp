            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="POST" action="../../../controlleurLogin" class="pt-3">
                <div class="form-group">
                    <input  name="Votre code" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Votre code">
                </div>
                <!--<div class="form-group">
                  <input type="password" name="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password">
                </div>-->
                <div class="mt-3">
                    <a href="login.jsp" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" />Reset password </a>
